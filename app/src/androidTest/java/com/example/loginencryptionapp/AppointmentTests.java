...
public class AppointmentTests {
    ...
    public void setUp() {
        ...
        // Clears existing data and adds new automated test entries
    ...
    public void testAddAndDeleteAppointment() {
        ...
        onData(Matchers.allOf(
                Matchers.is(Matchers.instanceOf(Doctor.class)),
                Matchers.hasToString(Matchers.containsString("Dr. Smith"))
        )).perform(click());
